...
const int IMPULSE_23			= 23;			// change to light kart
const int IMPULSE_24			= 24;			// change to medium kart
const int IMPULSE_25			= 25;			// change to heavy kart
const int IMPULSE_26			= 26;			// give all
